...
public class TeamsServiceTests {
    ...
    @BeforeEach
    void init() {
        user = usersRepository.createUser("text@example.com", "abc", "Test user", UUID.randomUUID());
    }
    ...
    void inviteTeamMember_success() {
        final var user = usersRepository.createUser("test@example.com", "pswd", "Test user", UUID.randomUUID());
    ...
    void getTeams_withoutMembershipStatusFilter_success() {
        ...
        final var user2 = usersRepository.createUser("test@example.com", "pswd", "Test user", UUID.randomUUID());
    ...
    void getTeamMembers_success() {
        ...
        final var user2 = usersRepository.createUser("text1@example.com", "abc", "Test user", UUID.randomUUID());
    ...
    void deleteTeamMember_userIsNotTeamOwner_forbiddenException() {
        final var team = service.createTeam(user.userUuid(), "Test team 1");
        final var user2 = usersRepository.createUser("test1@example.com", "abc", "Test user", UUID.randomUUID());
        service.inviteTeamMember(team.teamUuid(), user.userUuid(), user2.email());
        final var user3 = usersRepository.createUser("test2@example.com", "abc", "Test user", UUID.randomUUID());
